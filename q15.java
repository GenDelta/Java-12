...
/*Output:
Enter a string:
skjhdjkahjkdhas JKHAJKSHDJKHDJKAHDJKASH jkhasjkhahsjkdhjkha yuwtyetqeque xbnbcnmbdbhfagsd egdyjagsdjgs.?????////shjgdjhas ksahdkjashdjk
INVALID LENGTH
Give input of correct length again:
s
INVALID LENGTH
Give input of correct length again:
My name is Ankush Dutta. 
Output : Zl anzr vf Naxhfu Qhggn. 
*/                
